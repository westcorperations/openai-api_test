...
trait HttpResponseTrait
{
     ...
     * @return JsonResponse
     */
    public static function success(array $data, $statusCode = 200): JsonResponse
    {
     ...
     * @return JsonResponse
     */
    public function authError($message = 'incorrect credentials', $statusCode = 401): JsonResponse
    {
        return response()->json(['success' => false, 'error' => $message], $statusCode);
    }
